import argparse
import sys
from traverse.pso_sac import plan
from traverse.cli.main import generate_random_setup

def main():
    parser = argparse.ArgumentParser(description="Run Hybrid PSO-SAC Multi-Agent Path Planning")
    ...
    parser.add_argument("--episodes", type=int, default=3, help="Number of evaluation episodes to run (each runs training + testing, default: 3 due to imitation learning compile overhead)")
    args = parser.parse_args()

    print("\n===== HYBRID PSO-SAC EVALUATION STARTED =====\n")
    ...
    for ep in range(args.episodes):
        ...
        # Run package Hybrid PSO-SAC training and planning solver
        result = plan(args.grid_size, obstacles, starts, goals)
