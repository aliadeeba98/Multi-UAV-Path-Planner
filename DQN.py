...
def main():
    parser = argparse.ArgumentParser(description="Run Deep Q-Network (DQN) Multi-Agent Path Planning")
    ...
    for ep in range(args.episodes):
        ...
        # Run package DQN training and planning solver
        result = plan(args.grid_size, obstacles, starts, goals, mode="DQN")
